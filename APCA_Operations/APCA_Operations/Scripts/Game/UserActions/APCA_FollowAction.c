class APCA_FollowAction : ScriptedUserAction {
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity)
	{
		...
		if (!m_FollowWaypoint)
		{
			...
			//m_FollowWaypoint = SCR_EntityWaypoint.Cast(SpawnEntityPrefab(wpRes, pUserEntity.GetOrigin()));
			EntitySpawnParams params = EntitySpawnParams();
	        vector mat[4];
	        mat[3] = pUserEntity.GetOrigin();
	        params.Transform = mat;
			AIWaypoint waypoint = AIWaypoint.Cast(GetGame().SpawnEntityPrefab("{712F4795CF8B91C7}Prefabs/AI/Waypoints/AIWaypoint_GetIn.et", false, null, params));
		}
